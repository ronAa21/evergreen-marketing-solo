 ...
 * Format: PREFIX-XXXX-YYYY (e.g., CHA-1234-2024 or SA-5678-2024)
 * @param PDO $pdo Database connection
 * @param string $accountType Account type name (e.g., 'Savings', 'Checking')
 * @return string Generated account number with appropriate prefix
 */
function generateAccountNumber($pdo, $accountType = 'Savings') {
    ...
    // Format: PREFIX-XXXX-YYYY (e.g., CHA-1234-2024 or SA-5678-2024)
    // XXXX is a 4-digit random number
    do {
        $randomDigits = str_pad(rand(0, 9999), 4, '0', STR_PAD_LEFT);
        $accountNumber = $prefix . '-' . $randomDigits . '-' . $currentYear;
