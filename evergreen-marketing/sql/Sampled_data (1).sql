...
(1, 1, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 115 DAY),
(2, 1, 500.00, 'Maintain minimum balance for 3 months', 'mission', NOW() - INTERVAL 90 DAY),
(3, 1, 1000.00, 'Refer a friend to open an account', 'mission', NOW() - INTERVAL 75 DAY),
(4, 1, 300.00, 'Use mobile banking 10 times', 'mission', NOW() - INTERVAL 50 DAY),
(5, 1, 200.00, 'Set up automatic bill payment', 'mission', NOW() - INTERVAL 30 DAY),
(6, 1, 100.00, 'Referral bonus - Friend signed up', 'referral', NOW() - INTERVAL 70 DAY),
(7, 2, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 90 DAY),
(8, 2, 500.00, 'Maintain minimum balance for 3 months', 'mission', NOW() - INTERVAL 70 DAY),
(9, 2, 300.00, 'Use mobile banking 10 times', 'mission', NOW() - INTERVAL 40 DAY),
(10, 2, 200.00, 'Set up automatic bill payment', 'mission', NOW() - INTERVAL 20 DAY),
(11, 3, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 75 DAY),
(12, 3, 500.00, 'Maintain minimum balance for 3 months', 'mission', NOW() - INTERVAL 65 DAY),
(13, 3, 1000.00, 'Refer a friend to open an account', 'mission', NOW() - INTERVAL 55 DAY),
(14, 3, 300.00, 'Use mobile banking 10 times', 'mission', NOW() - INTERVAL 35 DAY),
(15, 3, 200.00, 'Set up automatic bill payment', 'mission', NOW() - INTERVAL 15 DAY),
(16, 3, 100.00, 'Referral bonus - Friend signed up', 'referral', NOW() - INTERVAL 50 DAY),
(17, 4, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 60 DAY),
(18, 4, 300.00, 'Use mobile banking 10 times', 'mission', NOW() - INTERVAL 30 DAY),
(19, 5, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 45 DAY),
(20, 5, 500.00, 'Maintain minimum balance for 3 months', 'mission', NOW() - INTERVAL 35 DAY),
(21, 6, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 35 DAY),
(22, 6, 1000.00, 'Refer a friend to open an account', 'mission', NOW() - INTERVAL 25 DAY),
(23, 7, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 30 DAY),
(24, 7, 500.00, 'Maintain minimum balance for 3 months', 'mission', NOW() - INTERVAL 20 DAY),
(25, 8, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 25 DAY),
(26, 9, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 20 DAY),
(27, 9, 500.00, 'Maintain minimum balance for 3 months', 'mission', NOW() - INTERVAL 10 DAY),
(28, 10, 100.00, 'Complete your first transaction', 'mission', NOW() - INTERVAL 15 DAY),
-- Reward Redemptions (Negative Points)
(29, 1, -500.00, 'Redeemed: ₱500 Gift Card', 'redemption', NOW() - INTERVAL 45 DAY),
(30, 1, -300.00, 'Redeemed: Mobile Phone Load', 'redemption', NOW() - INTERVAL 20 DAY),
(31, 2, -200.00, 'Redeemed: ₱200 Gift Card', 'redemption', NOW() - INTERVAL 25 DAY),
(32, 3, -1000.00, 'Redeemed: ₱1000 Shopping Voucher', 'redemption', NOW() - INTERVAL 30 DAY),
(33, 3, -500.00, 'Redeemed: ₱500 Gift Card', 'redemption', NOW() - INTERVAL 10 DAY),
(34, 6, -800.00, 'Redeemed: ₱800 Shopping Voucher', 'redemption', NOW() - INTERVAL 12 DAY),
(35, 7, -300.00, 'Redeemed: Mobile Phone Load', 'redemption', NOW() - INTERVAL 8 DAY),
(36, 9, -200.00, 'Redeemed: ₱200 Gift Card', 'redemption', NOW() - INTERVAL 5 DAY)
