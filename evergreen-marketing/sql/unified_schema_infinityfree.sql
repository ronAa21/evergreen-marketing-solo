-- ========================================
-- UNIFIED DATABASE SCHEMA - InfinityFree Version
-- ========================================
-- Modified for InfinityFree hosting
-- Database will use the pre-created database: if0_41648719_bankingdb
-- 
-- IMPORTANT: Make sure you've selected your database in phpMyAdmin before importing!
-- ========================================
